...
func (l *Log) CalculateStats() {
	l.ErrorRate = fmt.Sprintf("%.2f%%", calculatePercentage(float64(l.Failures), float64(l.EventsSent)))
	l.SuccessRate = fmt.Sprintf("%.2f%%", calculatePercentage(float64(l.EventsSent-l.Failures), float64(l.EventsSent)))
